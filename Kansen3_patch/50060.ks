;//block:A007
;//ƒuƒƒbƒN‚T‚O‚O‚S‚O‚©‚ç‘I‘ğˆ‚Åjump
;//ƒuƒƒbƒN‚T‚O‚O‚U‚Ow’nã‚k‚`‚r‚d‚q‚Öx
;//@konya 11/12 bg“\•t

*50060_TOP
;{SceneSet ’nã‚k‚`‚r‚d‚q‚Ö}
;//---------------------------------------------------------------
;//”wŒiFƒXƒNƒ‰ƒ“ƒuƒ‹Œğ·“_E¼—m•S‰İ“XEˆä‚Ì“ª’Ê‚è
;//@@@EuƒLƒƒXƒMƒ^ƒJƒVv‘OEu‚Å‚Å‚Á‚Û‚¤v
;//“oêl•¨:ålŒöE—I”¿E_•Eƒ}ƒ‹ƒKƒŠ[ƒ^E—øEq
;//ŠÔ‘ÑF
;//EƒeƒLƒXƒg—e—ÊF2K‘OŒã
;//---------------------------------------------------------------
;//œŒÀ®‘I‘ğˆ‚`‚P@‚P‚QF¼—m•S‰İ“X•ûŒü‚©‚ç
...
[ChrSetEx layer=3 chbase="kansen_d"][ChrSetXY layer=3 x=-40 y=0][trans_c cross time=150]
