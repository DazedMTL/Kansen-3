;//œ‚k‚`‚r‚d‚q@ÅŒã‚Ì’†Œpi‚Pj
;//ƒuƒƒbƒN‚s‚U‚O‚O‚R‚OwÅŒã‚Ì’†Œpi‚Pjx
;//@konya 11/13 BG“\•t
...
;//
;//¦‚±‚Ì‚s‚U‚O‚O‚R‚O‚ÍƒqƒƒCƒ“‚ª‘Sˆõ¶‚«c‚Á‚Ä‚¢‚éê‡‚É“Ë“ü‚µ‚Ü‚·B
;//---------------------------------------------------------------
;//block:A001
;//š‚±‚Ìƒtƒ@ƒCƒ‹‚Í‚s‚U‚O‚O‚P‚O‚ğƒRƒs[‚µA•”•ª“I‚É•ÏX‚µ‚Ä‚¢‚Ü‚·B
;//ˆê•”‚ÌƒZƒŠƒt‚Í‚s‚U‚O‚O‚Q‚O‚©‚ç‚ÌƒRƒs[‚Å‚·
