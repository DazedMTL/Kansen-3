...
*1041|
[fc]
Maruko-senpai, who was so strong... those men were nothing compared to her...[pcms]
...
*1043|
[fc]
A little away from Maruko-senpai, Yuuho's body lay sprawled.[pcms]

*1044|
[fc]
Her eyes, wide open and vacant, reflected nothing. She used to be so[r]
expressive...[pcms]
...
*1046|
[fc]
Sorrow and anger surged through me, almost driving me mad.[pcms]

*1047|
[fc]
It's terrible... why did this happen...[pcms]
...
*1064|
[fc]
They were speechless at the sight of this tragedy, just like me.[pcms]
...
[fc]
[ns]Wataru[nse]
"It's here, your violin. Look, it's all here"[pcms]
...
[fc]
[ns]Wataru[nse]
"Don't strain yourself, we're going to take you to the hospital soon..."[pcms]
...
[fc]
[ns]Wataru[nse]
"Ren will get better too, let's fix the violin together"[pcms]
...
*1084|
[fc]
She's slipping away... Ren is... Ren is...[pcms]

*1085|
[fc]
[vo_ren s="ren_BE0009"]
[ns]Ren[nse]
"Being your sister... made me happy"[pcms]

*1086|
[fc]
[ns]Wataru[nse]
"I was happy to have Ren as my sister too. I feel the same"[pcms]

*1087|
[fc]
[vo_ren s="ren_BE0010"]
[ns]Ren[nse]
"In the end, I got to be your lover... truly..."[pcms]
...
*1090|
[fc]
She was muttering words like she was delirious.[pcms]
...
*1100|
[fc]
I put Ren's violin back in its case that was lying around.[pcms]

*1101|
[fc]
I can't die until I fix this violin.[pcms]
...
[fc]
[ns]Kousuke[nse]
"Mizuki, you should go too, go with Wataru."[pcms]

[ChrSetEx layer=5 chbase="mizu_f4"][ChrSetXY layer=5 x=160 y=0][trans_c cross time=150]

*1105|
[fc]
[vo_miz s="mizuki_BE0066"]
[ns]Mizuki[nse]
"No, I don't want to leave... besides... I'm sure I also..."[pcms]
...
*1107|
[fc]
I was staggering back the way I came.[pcms]

*1108|
[fc]
This violin... Ren's violin...[pcms]

*1109|
[fc]
The violin can be fixed...[pcms]
...
;	;//★_DJ-BAR
;	;//<ChrInit>
;	;//[bg storage="BG019d"]<UpDate Cross,1000>
;	;//;[eval exp="f.l_map = 24"]
;	;//ドーンオブザデッドな夜明けを提唱したい
...
;	*1118|
;	[fc]
The quiet streets, the buildings like tombstones, and slowly the sun began to[r]
rise beyond them.[pcms]
;
;	*1119|
;	[fc]
...
;	*1121|
;	[fc]
With the piercing blue sky burned into my eyelids, I tell Mizuki, the person[r]
...
;	*1125|
;	[fc]
...But that's right. It's not like there's nothing to be afraid of. We are[r]
still... "human" after all.[pcms]
;
;	;//★_DJ-BAR
;	;//<ChrInit>
...
;	*1135|
;	[fc]
She had a face that was completely at peace, entrusting everything to me.[pcms]
;
;	*1136|
;	[fc]
...
[ns]Mizuki[nse]
"None at all, as long as I'm with you, Kousuke."[pcms]
;
;	;mm なんで浩助視点で貼ってあんのさ
;	;[ChrSetEx layer=5 chbase="kou_e1"][ChrSetXY layer=5 x=161 y=0][trans_c cross time=150]
;
...
;	*1143|
;	[fc]
While holding Mizuki's body, I casually moved our footing to the side.[pcms]
;
;	*1144|
;	[fc]
...
;	*1147|
;	[fc]
Believing that the next time we open our eyes... that time will come.[pcms]
;
;	;システムボタン＆ウィンドウ消去
;	[sysbt_meswin clear]
;
...
*1151|
[fc]
Just one scratch from them and it's over.[pcms]

*1152|
[fc]
You become one of them and wander around Shibuya from tomorrow.[pcms]
...
*1154|
[fc]
Thinking this while holding the violin case.[pcms]
...
*1157|
[fc]
If I get through there, it's a straight shot to "Dedepou."[pcms]

*1158|
[fc]
Somehow, I can escape.[pcms]
...
*1160|
[fc]
I pulled the trigger at an infected nearby who seemed to obstruct my path.[pcms]
...
*1162|
[fc]
Screaming, I sprinted towards the emergency exit.[pcms]

*1163|
[fc]
The slowly moving infected couldn't react to me running straight past them.[pcms]
...
*1164|
[fc]
I shoot down the infected in my path.[pcms]

*1165|
[fc]
And... what I saw after tumbling out the emergency exit was...[pcms]
...
*1167|
[fc]
I have to live... I must live...[pcms]
...
;//---------------------------------------------------------------
;//---------------------------------------------------------------
;//クリアしてると漣がひどいめに遭うシーンを見るザッピング

[if exp="sf.g_clear == 1 && f.l_sex_r == 1"][jump storage="BE10140.ks" target=*01][endif]
[jump storage="BE10140.ks" target=*02]
...
;	*aspect_SEL漣
;	[selbt_clear]
;	[jump storage="BEH_10020.ks" target=*BEH_10020_TOP]
;
;	*aspect_SELキャンセル
;	[selbt_clear]
;	[jump storage="BE10140.ks" target=*02]
