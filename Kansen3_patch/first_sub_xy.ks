...
;===========================================================
;アスペクトボタン　
[eval exp="sf.aspect1_x = 60"]
[eval exp="sf.aspect2_x = 460"]
[eval exp="sf.aspect3_x = 100"]
[eval exp="sf.aspect4_x = 500"]
[eval exp="sf.aspect5_x = 639"]

[eval exp="sf.aspect1_y = 120"]
[eval exp="sf.aspect2_y = 214"]
[eval exp="sf.aspect3_y = 307"]
[eval exp="sf.aspect4_y = 402"]
[eval exp="sf.aspect5_y = 542"]

[eval exp="sf.asp悠帆_x = sf.aspect1_x , sf.asp悠帆_y = sf.aspect1_y"][eval exp="sf.aspれん_x = sf.aspect2_x , sf.aspれん_y = sf.aspect1_y"]
[eval exp="sf.aspマル_x = sf.aspect1_x , sf.aspマル_y = sf.aspect2_y"][eval exp="sf.asp瑞樹_x = sf.aspect2_x , sf.asp瑞樹_y = sf.aspect2_y"]
[eval exp="sf.asp浩助_x = sf.aspect1_x , sf.asp浩助_y = sf.aspect3_y"][eval exp="sf.aspじん_x = sf.aspect2_x , sf.aspじん_y = sf.aspect3_y"]
[eval exp="sf.aspほか_x = sf.aspect1_x , sf.aspほか_y = sf.aspect4_y"]
[eval exp="sf.aspやめ_x = sf.aspect5_x , sf.aspやめ_y = sf.aspect5_y"]
...
[eval exp="tf.bgmTitle = 'BGM06'"]

;マス目の座標を作る
[eval exp="tf.T_bt_x = []"]
[eval exp="tf.T_bt_xadd = 200"]
[eval exp="tf.T_bt_x[0] = 20"]
...
;ロード
[eval exp="sf.T_load_x = tf.T_bt_x[1]"]
[eval exp="sf.T_load_y = tf.T_bt_y[0]"]

;クイックロード
[eval exp="sf.T_Qload_x = tf.T_bt_x[2]"]
[eval exp="sf.T_Qload_y = tf.T_bt_y[0]"]

;コンフィグ
[eval exp="sf.T_conf_x = tf.T_bt_x[3]"]
[eval exp="sf.T_conf_y = tf.T_bt_y[0]"]

;プロローグスキップ
[eval exp="sf.T_pski_x = tf.T_bt_x[0]+50"]
[eval exp="sf.T_pski_y = tf.T_bt_y[1]"]

 
;アペンドエクストラ
[eval exp="sf.T_extra_x = tf.T_bt_x[1]+100"]
[eval exp="sf.T_extra_y = tf.T_bt_y[1]"]


;ゲーム終了
[eval exp="sf.T_quit_x = tf.T_bt_x[2]+150"]
[eval exp="sf.T_quit_y = tf.T_bt_y[1]"]
...
;CG Gallery
[eval exp="sf.T_cg_x = tf.T_bt_x[0]+80"]
[eval exp="sf.T_cg_y = tf.T_bt_y[1]-20"]

;Scene Replay
[eval exp="sf.T_sr_x = tf.T_bt_x[1]+90"]
[eval exp="sf.T_sr_y = tf.T_bt_y[1]-20"]

;BGM MOde
[eval exp="sf.T_bgm_x = tf.T_bt_x[2]+130"]
[eval exp="sf.T_bgm_y = tf.T_bt_y[1]-20"]
...
[eval exp="sf.bt_num_chara06     = 19"]
[eval exp="sf.bt_num_chara07     = void"]
[eval exp="sf.bt_num_v_stop      = 20"]
[eval exp="sf.bt_num_v_autowait  = 21"]
...
;20 キャラボイス6
;ON OFF
[eval exp="sf.conf_vo6_onoff_x = 765"]
[eval exp="sf.conf_vo6_onoff_y = tf.step8"]

;21 キャラボイス7
;ON OFF
[eval exp="sf.conf_vo7_onoff_x = 765"]
...
; サンプルウィンドウ文字列
[eval exp="sf.kidoku_sampletext = ' 姦染３ ―首都崩壊―'"]
...
[eval exp="sf.namechip_x = 90"]
[eval exp="sf.namechip_y = 390"]
...
[eval exp="sf.selold_y[3] = sf.selold_y[1] + 80"]
	[eval exp="sf.selold_y[4] = sf.selold_y[2] + 80"]
[eval exp="sf.selold_y[5] = sf.selold_y[1] + 80*2"]
	[eval exp="sf.selold_y[6] = sf.selold_y[2] + 80*2"]
[eval exp="sf.selold_y[7] = sf.selold_y[1] + 80*3"]
...
;ページ用ボタン
;1ページ目
[eval exp="sf.b_page01_x = 320"]
[eval exp="sf.b_page01_y =   5"]
;2ページ目
[eval exp="sf.b_page02_x = 400"]
[eval exp="sf.b_page02_y =   5"]
; 3ページ目
[eval exp="sf.b_page03_x = 480"]
[eval exp="sf.b_page03_y =   5"]
;4ページ目
[eval exp="sf.b_page04_x = 560"]
[eval exp="sf.b_page04_y =   5"]
;5ページ目
[eval exp="sf.b_page05_x = 640"]
[eval exp="sf.b_page05_y =   5"]
;6ページ目
[eval exp="sf.b_page06_x = 720"]
[eval exp="sf.b_page06_y =   5"]
...
[eval exp="sf.bgm07_y  = tf.BGM_bt_y[1]"]
;BGM 7個目ボタン
...
[eval exp="sf.bgm08_y  = tf.BGM_bt_y[2]"]
;BGM 8個目ボタン
...
[eval exp="sf.bgm09_y  = tf.BGM_bt_y[3]"]
;BGM 9個目ボタン
...
[eval exp="sf.bgm10_y  = tf.BGM_bt_y[4]"]
;BGM 10個目ボタン
...
[eval exp="sf.bgm11_y  = tf.BGM_bt_y[5]"]
;BGM 11個目ボタン
