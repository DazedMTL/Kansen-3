;//ƒuƒƒbƒN‚s‚S‚O‚O‚R‚Ow—ø‚ÌƒoƒCƒIƒŠƒ“x
;//@konya 11/13 BG“\•t
...
*6815|
[fc]
That might be nice... Or rather, it's really nice...!?[pcms]
...
[vo_ren s="ren_T0044"]
[ns]Ren[nse]
"...Geez, it's just a joke~!!"[pcms]
;//—‚ ‚í‚Ä‚¬‚İ

;//š‚±‚±‚©‚çA‚s‚S‚O‚O‚S‚O‚Å—¬—p‚µ‚Ü‚·
...
*6825|
[fc]
Naughty books!? Could it be... she found my collection!?[pcms]
...
*6828|
[fc]
Whoa, this isn't just teasing! She really found out!![pcms]
...
[vo_ren s="ren_T0048"]
[ns]Ren[nse]
"Moo-! That's mean, big brother!"[pcms]
...
[fc]
[ns]Wataru[nse]
"If you say that, I'll tickle you!?"[pcms]
...
[vo_ren s="ren_T0050"]
[ns]Ren[nse]
"No, nooo! Stop that tickling with your fingers, pleaseee!?"[pcms]
;//—”¼•ªÎ‚¢‚È‚ª‚çi‚­‚·‚®‚½‚¢‚Ì‚ª‹êèB”¼•ªA–{‹C‚Å‚â‚ß‚Ä‚Ù‚µ‚¢j

*6841|
[fc]
[ns]Wataru[nse]
"Fufufufufu, I see right through your weakness-"[pcms]
...
;//se097E‘–‚è‚ñ‚Å‚­‚é‘«‰¹iˆêlj
;//[se buf=0 storage="se097"]
;[stopse buf=0]
[stopbgm]

;//ƒoƒCƒIƒŠƒ“‚Ì‰¹AƒXƒgƒbƒv
