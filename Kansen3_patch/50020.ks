...
[vo_mar s="maru1296"]
[ns]Margarita[nse]
"Not just medicine... If we go there, we can get UV cream."[pcms]

*143|
[fc]
[ns]Wataru[nse]
"Ah...! I see, for Ren's...!"[pcms]

[ChrSetEx layer=5 chbase="maru_a3"][ChrSetXY layer=5 x=147 y=0][trans_c cross time=150]

*144|
[fc]
Senpai let out a small smile.[pcms]
...
[fc]
[ns]Wataru[nse]
"Thank you, Maruko-senpai. For thinking about Ren..."[pcms]
...
[vo_yuh s="yuho1455"]
[ns]Yuuho[nse]
"...Okay! The supply team, moving out!"[pcms]
...
*158|
[fc]
Kousuke and Maruko-senpai stared at each other for a moment.[pcms]
...
[vo_ren s="ren1314"]
[ns]Ren[nse]
"Maruko-senpai is blushing..."[pcms]
;//＠小声
...
;//---------------------------------------------------------------
;//●選択肢Ａ１
;//１１：ドラッグストアへ→ブロック５００３０へ
;//１２：僕が見に行きます→ブロック５００４０へ
...
[eval exp="f.seltext02 = 'To the drugstore'"]
[eval exp="f.seltext04 = 'I\'ll go take a look'"]
...
[sel02 target=*SEL40_1]
[sel04 target=*SEL40_2]
[s]
...
[jump storage="50030.ks" target=*50030_TOP]
;-------------------------------------------------------------------------------
*SEL40_2|&f.seltext04
[sel_hisout txt="&f.seltext04"][hr][fc][selbt_clear]
[jump storage="50040.ks" target=*50040_TOP]
;//---------------------------------------------------------------
